...
class DataProxy:
    ...
    DATA_PROXIES_ROOT_FOLDER = '/home/mtman/Documents/Repos/yakwith.ai/voice_chat/data_proxies'

    @classmethod
    def get_all(cls, data_source_name: str, root: str=DATA_PROXIES_ROOT_FOLDER ) -> List[Dict]:
    ...
    @classmethod
    def verify_client_authorized(cls, authorization_key: str, data_source_name:str = 'authorized_clients', root: str=DATA_PROXIES_ROOT_FOLDER) -> bool:
    ...
    @classmethod
    def get_3p_service_configs(cls, authorization_key: str, authorization_data_source_name:str, service_name: str, service_data_source_name:str, root: str=DATA_PROXIES_ROOT_FOLDER)->Dict:
        '''Get the settings for the 3rd party api'''
        response = None
        
        authorized = cls.verify_client_authorized(authorization_key,authorization_data_source_name, root=root)
        if not authorized:
